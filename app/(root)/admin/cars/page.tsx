...
import AddVehicalForm from '@/components/ui/dashboard/car/add-form';
        ...
        <div className='flex-1 overflow-y-auto p-6 bg-gray-100 h-full'>
            ...
            <div className='flex justify-between items-center mb-4'>
                ...
                <div className='relative'>
                    ...
                    <Input placeholder='Search car' className='pl-8 w-[300px] bg-white' />
                </div>
            </div>
            <CustomTable columns={columns} data={carData} />
        </div>
    )
}
